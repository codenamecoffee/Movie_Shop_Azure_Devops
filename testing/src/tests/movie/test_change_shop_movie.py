...
class TestChangeShopMovie:
    ...
    @pytest.mark.smoke
    def test_change_a_movie_from_one_shop_to_another_id_specified_shop(
        self, movie_service, shop_service, created_movie, sample_shop_data
    ):
        new_shop = shop_service.create_shop(
            shop=AddShopModel(**sample_shop_data),
            response_type=dict
        ).data
    ...
    def test_change_a_movie_from_one_shop_to_a_non_existent_id_specified_shop(
        self, movie_service, created_movie
    ):
    ...
    @pytest.mark.negative
    def test_change_a_non_existent_movie_from_one_shop_to_another_id_specified_shop(
        self, movie_service, created_shop
    ):
